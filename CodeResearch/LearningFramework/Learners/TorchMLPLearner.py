...
class TorchMLPLearner(TorchLearner):
    """
    ...
    def __init__(self, input_dim: int, num_classes: int, hidden_sizes: Sequence[int] = (128, 64),
                 activation: str = "relu", dropout: float = 0.0, lr: float = 1e-3, batch_size: int = 32,
                 epochs: int = 20, update_epochs: int = 1, weight_decay: float = 0.0,
